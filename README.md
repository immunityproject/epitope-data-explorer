# epitope-data-explorer
Basic ReactJS app to download and explore epitopedata from the pySE compute_shannon_entropy tool

# ReactJS README (Automatically Generated)
